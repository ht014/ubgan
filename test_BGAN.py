...
def inference(x64,xx224):
        ...
        with tf.variable_scope("enc"):
            ...
            hash_codes, real_codes = DoublySN(hiden_layer__, hepsilon)
        ...
        return real_codes,hash_codes,gen_img,dis_fake,dis_real,gen_img2
...
with graph.as_default():
    ...
    with tf.device('/gpu:'+str(gpu_num)):
        with tf.name_scope('Tower_0') as scope:
            ...
            grads_e = opt_E.compute_gradients(SSE_loss1+reg_e*0 + 0*N_loss,var_list=G_params)
...
while epoch < num_epochs:
    ...
    for i in range(total_batch):
        ...
        print "epoch:{0},MSE_loss:{1}".format(cur_epoch / total_batch, mse_loss1)
    epoch += 1
